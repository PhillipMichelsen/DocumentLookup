...
class JobUtils:
    ...
    def create_job(self, job_name: str, job_id: str, initial_request_content: str) -> None:
        """Creates a job
        ...
        for task in self.jobs[job_name].tasks:
            task_chain_ids.append(task_utils.store_task(task, job_id))
    ...
    @staticmethod
    def step_task_index(job_id: str) -> None:
